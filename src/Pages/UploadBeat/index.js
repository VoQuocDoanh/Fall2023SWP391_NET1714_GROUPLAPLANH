...
function UploadBeat() {
  ...
  //Validation
  const form = { beatname: beatName, price: price,  beatsound: beatSound };
  let err = ValidationUpload(form);
  console.log(err);
  setError(err);
      ...
      <div className={cx("form")}>
        ...
        <div className={cx("input")}>
          ...
          >
            ...
            <option value="1">Nhac dong que</option>
          </select>
        </div>
